...
const docs = [
  ...
  /* ── PAGE: O MNIE ── */
  {
    ...
    trials: [
      { _key: 'tr1', title: 'Odejście z bankowości', desc: 'Po latach w złotych kajdanach korporacji odszedłem z bezpiecznej pracy, by zacząć od nowa.' },
      { _key: 'tr2', title: 'Park technologiczny', desc: '7 lat tworzenia młodego zespołu i prowadzenia budowy parku technologicznego dla branży IT — od wizji do gotowego obiektu.' },
      { _key: 'tr3', title: 'Firma rodzinna', desc: 'Po niespodziewanej śmierci taty przejąłem rodzinną firmę budowlaną. 8 lat odpowiedzialności, pokory i lekcji, których nie da się przeczytać w żadnej książce.' },
    ],
